...
import org.atguigu.gulimall.auth.feign.MemberFeignService;
import org.atguigu.gulimall.auth.feign.ThirdPartFeignService;
...
//        String code = UUID.randomUUID().toString().substring(0, 5);
        ...
        // 3. 注释掉/删掉真实发短信代码，不用第三方服务了
//        thirdPartFeignService.sendCode(phone, code);
        // 短信服务要企业认证，我只是学习就不搞了，验证码直接aaa写死能用就行
        return R.ok();
    }
